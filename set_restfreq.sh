...
#specify explicitly rather than with wildcards otherwise you'll get "no match" and it won't do it
foreach dest ( 2016-04*.uv.split 2016-05*.uv.split 2016-08*.uv.split 2016-11*.uv.split 2017-02*.uv.split )
	...
	puthd in=./${dest}/1934-638.1420.5.6/restfreq value=1.420405752d0
        puthd in=./${dest}/1934-638.1419.5.2/restfreq value=1.420405752d0
	echo "DONE ${dest}"
end
